...
CREATE TABLE `menu_info` (
  `menu_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '系统菜单id',
  `menu_name` varchar(20) NOT NULL COMMENT '系统菜单名称',
  `menu_url` varchar(30) NOT NULL COMMENT '菜单路径',
  `menu_parent_id` int(10) NOT NULL COMMENT '父级菜单id，没有父菜单为0',
  PRIMARY KEY (`menu_id`),
