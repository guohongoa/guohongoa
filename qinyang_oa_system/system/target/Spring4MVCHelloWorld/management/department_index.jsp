    ...
    <div class="main">
        <div class="myservice">
            ...
            <div class="myservicecontent">
                <ul>
                    <li class="titleli"><a href="department_input.jsp">添加新部门</a></li>
                </ul>
            </div>
            <div class="myservicecontent">
                <ul>
                    <li class="titleli">
                          <form action="department_check.do" method="post" name="form_department">
                            <a href='javascript:document.form_department.submit();'><font color='#000000'>
                              查看现有部门
                            </font>
                            </a>
                          </form>
