...
$(document).ready(function(){
	...
	if($("p[id='node1']").attr('class')==0)
		{
		 $("h5#0").css("background-color","red");
		}
	else
		{
		$("h5#0").css("background-color","blue");
		}
    ...
    if($("div#level1.slxq p").length/2>1)
    ...
    else if($("p[id='node11']").attr('class')==0)
       {
    	...
    	{
    	$("h5#1").css("background-color","blue");
    	}
  ...
  $("div[id^='node']").click(function(){ //点击node结点
    ...
    if($("p[id='"+id+"']").attr('class')==0)
    	{
    	 $("h5#"+(id.length-5)).css("background-color","red");
    	}
    else
    	{
    	 $("h5#"+(id.length-5)).css("background-color","blue");
    	}
   ...
   if(child_len>1)
	   {
	   $("h5#"+(id.length-4)).css("background-color","red");
	   }
	   ...
	   {
	   $("h5#"+(id.length-4)).css("background-color","blue");
	   }
