...
<div class="content">
        ...
        <ul>
            ...
            <li><a href="work_all_check.do?employee_id=${user_id}&work_page=1" class="active">全部工作</a>
                <dl>
                    ...
                    <dd><a href="work_all_report.do?employee_id=${user_id}&work_page=1" >汇报的工作</a></dd>
                    <dd><a href="work_all_approved.do?employee_id=${user_id}&work_page=1" class="red"  style="border-bottom: 1px solid #c9c9c9;height: 35px">已审批</a></dd>
                </dl>
            </li>
        </ul>
    </div>
    ...
    <div class="page">
      ...
      <div class="page">
        <a href="work_all_approved.do?work_page=1&employee_id=${user_id}">上一页</a>
        <a href="work_all_approved.do?work_page=1&employee_id=${user_id}" class="bulec">1</a>
        <a href="work_all_approved.do?work_page=2&employee_id=${user_id}">2</a>
        <a href="work_all_approved.do?work_page=3&employee_id=${user_id}">3</a>
        <a href="work_all_approved.do?work_page=4&employee_id=${user_id}">4</a>
        <a href="work_all_approved.do?work_page=5&employee_id=${user_id}">5</a>
        <a href="work_all_approved.do?work_page=2&employee_id=${user_id}">下一页</a>
        <a>共${work_total_page}页</a>
        <form method="get" action="work_all_approved.do">
        <a>
      ...
      <div class="page">
        <a href="work_all_approved.do?work_page=1&employee_id=${user_id}">上一页</a>
        <a href="work_all_approved.do?work_page=1&employee_id=${user_id}">1</a>
        <a href="work_all_approved.do?work_page=2&employee_id=${user_id}" class="bulec">2</a>
        <a href="work_all_approved.do?work_page=3&employee_id=${user_id}">3</a>
        <a href="work_all_approved.do?work_page=4&employee_id=${user_id}">4</a>
        <a href="work_all_approved.do?work_page=5&employee_id=${user_id}">5</a>
        <a href="work_all_approved.do?work_page=3&employee_id=${user_id}">下一页</a>
        <a>共${work_total_page}页</a>
        <form method="get" action="work_all_approved.do">
        <a>
           到&nbsp;<input type="text" name="work_page" style="width:15px;">&nbsp;页
      ...
      <c:otherwise>
      <div class="page">
        <a href="work_all_approved.do?work_page=${work_page-1}&employee_id=${user_id}">上一页</a>
        <a href="work_all_approved.do?work_page=${work_page-2}&employee_id=${user_id}">${work_page-2}</a>
        <a href="work_all_approved.do?work_page=${work_page-1}&employee_id=${user_id}">${work_page-1}</a>
        <a class="bulec" href="work_all_arrange.do?work_page=${work_page}&employee_id=${user_id}">${work_page}</a>
        <a href="work_all_approved.do?work_page=${work_page+1}&employee_id=${user_id}">${work_page+1}</a>
        <a href="work_all_approved.do?work_page=${work_page+2}&employee_id=${user_id}">${work_page+2}</a>
        <a href="work_all_approved.do?work_page=${work_page+1}&employee_id=${user_id}">下一页</a>
