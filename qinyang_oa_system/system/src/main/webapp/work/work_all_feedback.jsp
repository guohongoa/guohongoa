...
<div class="content">
        ...
        <ul>
            ...
            <li><a href="work_all_check.do?employee_id=${user_id}&work_page=1" class="active">全部工作</a>
                <dl>
                    ...
                    <dd><a href="work_all_feedback.do?employee_id=${user_id}&work_page=1" class="red" >反馈的工作</a></dd>
    ...
    <div class="right_content">
        <h4><a href="">工作</a>&gt;<a href="work_all_check.do?employee_id=${user_id}&work_page=1">工作任务</a>&gt;<a href="work_all_check.do?employee_id=${user_id}&work_page=1">全部工作</a>&gt;<span>反馈的工作</span>
