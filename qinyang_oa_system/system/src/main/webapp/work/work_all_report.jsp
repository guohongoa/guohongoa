...
<div class="content">
    ...
    <div class="page">
      ...
      <div class="page">
        <a href="work_all_report.do?work_page=1&employee_id=${user_id}">上一页</a>
        <a href="work_all_report.do?work_page=1&employee_id=${user_id}" class="bulec">1</a>
        <a href="work_all_report.do?work_page=2&employee_id=${user_id}">2</a>
        <a href="work_all_report.do?work_page=3&employee_id=${user_id}">3</a>
        <a href="work_all_report.do?work_page=4&employee_id=${user_id}">4</a>
        <a href="work_all_report.do?work_page=5&employee_id=${user_id}">5</a>
        <a href="work_all_report.do?work_page=2&employee_id=${user_id}">下一页</a>
        <a>共${work_total_page}页</a>
        <form method="get" action="work_all_report.do">
        <a>
      ...
      <div class="page">
        <a href="work_all_report.do?work_page=1&employee_id=${user_id}">上一页</a>
        <a href="work_all_report.do?work_page=1&employee_id=${user_id}">1</a>
        <a href="work_all_report.do?work_page=2&employee_id=${user_id}" class="bulec">2</a>
        <a href="work_all_report.do?work_page=3&employee_id=${user_id}">3</a>
        <a href="work_all_report.do?work_page=4&employee_id=${user_id}">4</a>
        <a href="work_all_report.do?work_page=5&employee_id=${user_id}">5</a>
        <a href="work_all_report.do?work_page=3&employee_id=${user_id}">下一页</a>
        <a>共${work_total_page}页</a>
        <form method="get" action="work_all_report.do">
        <a>
           到&nbsp;<input type="text" name="work_page" style="width:15px;">&nbsp;页
      ...
      <c:otherwise>
      <div class="page">
        <a href="work_all_report.do?work_page=${work_page-1}&employee_id=${user_id}">上一页</a>
        <a href="work_all_report.do?work_page=${work_page-2}&employee_id=${user_id}">${work_page-2}</a>
        <a href="work_all_report.do?work_page=${work_page-1}&employee_id=${user_id}">${work_page-1}</a>
        <a class="bulec" href="work_all_report.do?work_page=${work_page}&employee_id=${user_id}">${work_page}</a>
        <a href="work_all_report.do?work_page=${work_page+1}&employee_id=${user_id}">${work_page+1}</a>
        <a href="work_all_report.do?work_page=${work_page+2}&employee_id=${user_id}">${work_page+2}</a>
        <a href="work_all_report.do?work_page=${work_page+1}&employee_id=${user_id}">下一页</a>
