...
<div class="fuwu_content">
    ...
    <div class="back">
        <a href="work_feedback.do?work_id=${work_info.get_work_id()}&work_page=${work_page}">反馈</a> &nbsp; <a href="work_feedback_list?work_page=${work_page}" style="margin-right: -15px">返回</a>
    </div>
</div>
