...
<div class="fuwu_content">
    <h4><a href="../work">工作</a>&gt;<a href="work_all_check.do?employee_id=${user_id}&work_page=1">工作任务</a>&gt;<a href="work_all_check.do?employee_id=${user_id}&work_page=1">全部工作</a>&gt;<a href="work_all_arrange.do?employee_id=${user_id}&work_page=1">安排的工作</a>&gt;详情
    <div class="wfwxq">
