...
<div class="m_content">
    ...
    <div class="left_menu">
        ...
        <ul>
            ...
            <li><a  href="service_economy_deploy.jsp">经济发展服务</a>
            </li>
            <li><a href="service_harmony_deploy.jsp">和谐稳定服务</a></li>
            <li><a href="service_environment_deploy.jsp">环境卫生服务</a>
            </li>
            <li><a class='active' href="service_activity_deploy.jsp">文体活动服务</a>
                <dl>
                    <dt></dt>
                    <dd class="activea"><a href="service_activity_deploy.jsp" >安排</a><i></i></dd>
        ...
        <div class="service">
            ...
            <form id="servicego" action="send_service.do" method="post">
                ...
                <div>
                    ...
                    <p class="serviceinput disabled"><input id="type" type="text" value="文体活动服务" disabled /></p>
                </div>
                <div>
                ...
                <input type="hidden" name="service_type" value="4" />      <!--文体活动服务为4-->
