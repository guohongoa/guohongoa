            ...
            <form action="employee_modify_commit.do" method="post">
               <input type="hidden" name="employee_id" value="${employee_info.get_employee_id()}"/>
                ...
                <div class="clear">
                    ...
                    <p><span>入职日期</span>
                        <input class="input200 timedata" name="employee_addworktime" type="text" value="${employee_info.get_employee_position()}"/></p>
                </div>
                <div>
                    <p><span>所属部门</span>
                        <input class="input200" name="employee_department" type="text" value="${employee_info.get_employee_addworktime()}"/></p>
                    <p><span>直接上级</span>
                        <input class="input200" name="employee_leader" type="text" value="${employee_info.get_employee_leader()}"/></p>
                </div>
                <div>
