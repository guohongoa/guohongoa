...
public class department_selector 
{
	 private int     department_id;    //部门id
	  ...
	  public int get_department_code()
	  {
	   ...
	   public int get_department_begin()
	   {
		   return this.department_begin;
	   }
	   
	   public void set_department_begin(int department_begin)
	   {
		   this.department_begin=department_begin;
	   }
