...
public class msg_selector 
{
	private int     msg_id;            //消息id
	  ...
	  public int get_msg_begin()
	  {
		  return this.msg_begin;
	  }
	  
	  public void set_msg_begin(int msg_begin)
	  {
		  this.msg_begin=msg_begin;
	  }
	  ...
	  public void set_msg_num(int msg_num)
	  {
