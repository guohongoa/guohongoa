    ...
    <div class="left_menu">
        <h3>五服务</h3>
         <ul>
            ...
            <li><a class='active' href="service_environment_deploy.jsp">环境卫生服务</a>
                <dl>
                    <dt></dt>
                    <dd class="activea"><a href="service_environment_deploy.jsp" >安排</a><i></i></dd>
        ...
        <div class="service">
            ...
            <form id="servicego" action="send_service.do" method="post">
                ...
                <div>
                    ...
                    <p class="serviceinput disabled"><input id="type" type="text" value="环境卫生服务" disabled /></p>
                </div>
                <div>
