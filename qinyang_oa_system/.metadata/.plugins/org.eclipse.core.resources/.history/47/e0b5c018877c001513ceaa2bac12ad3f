...
<div class="m_content">
    ...
    <div class="main">
        <div class="task">
            ...
            <form id="taskgo" action="../department_insert.do" method="post">
                <table>
                    <tr>
                        <td class="td1">部门名称</td>
                        <td class="td2"><div><input type="text" name="department_name"/></div></td>
                    </tr>
                    <tr>
                        <td>部门人数</td>
                        <td class="td2"><div><input type="text" name="department_num"/></div></td>
                    </tr>
                    <tr>
                        <td>部门领导</td>
                        <td class="td2"><div><input type="text" name="department_leader"/></div></td>
                    </tr>
                    <tr>
                        <td>制度职责</td>
                    </tr>
                    <tr>
                        <td colspan="2" >
                            <textarea name="department_duty"></textarea>
                        </td>
                    </tr>
                </table>
                <input id="tasks" type="submit" value="添加新部门"/>
            </form>
        </div>
    </div>
</div>
