        ...
        <ul>
            <li><a class='active' href="service_law_deploy.jsp">法政法规服务</a>
                <dl>
                    ...
                    <dd><a href="service_law_feedback.jsp">反馈</a></dd>
                </dl>
            </li>
        ...
        <div class="service">
            ...
            <form id="servicego" action="send_service.do" method="post">
                ...
                <div>
                    ...
                    <p class="serviceinput disabled"><input id="type" type="text" value="法政法规服务" disabled /></p>
                </div>
                <div>
                ...
                <input type="hidden" name="service_type" value="0" />      <!--法政法规服务为0-->
