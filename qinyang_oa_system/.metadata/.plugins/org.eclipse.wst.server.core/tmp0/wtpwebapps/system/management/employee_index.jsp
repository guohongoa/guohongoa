...
<div class="m_content">
    ...
    <div class="left_menu">
        <h3>管理</h3>
        <ul>
            <li><a href="serviceone.html" class="active">人员管理</a>
            </li>
    ...
    <div class="main">
        <div class="myservice">
            ...
            <div class="myservicecontent">
                <ul>
                    <li class="titleli"><a href="employee_input.jsp">添加新部门</a></li>
                </ul>
            </div>
            <div class="myservicecontent">
                <ul>
                    <li class="titleli">
                          <form action="employee_check.do" method="post" name="form_employee">
                            <a href='javascript:document.form_employee.submit();'><font color='#000000'>
                              查看现有部门
                            </font>
                            </a>
                          </form>
