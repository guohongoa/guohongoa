    ...
    <div class="main">
        <div class="myservice">
            ...
            <div class="myservicecontent">
                <ul>
                    <li class="titleli"><a href="project_input.jsp">添加新项目</a></li>
                </ul>
            </div>
            <div class="myservicecontent">
                <ul>
                    <li class="titleli">
                          <form action="project_check.do" method="post" name="form_project">
                            <a href='javascript:document.form_project.submit();'><font color='#000000'>
                              查看现有项目
                            </font>
                            </a>
                          </form>
