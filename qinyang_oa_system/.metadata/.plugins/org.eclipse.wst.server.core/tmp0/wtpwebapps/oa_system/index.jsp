			...
			<div class="span12">
				<div class="tabbable" id="tabs-105576">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#panel-fiveservice"
							data-toggle="tab">五服务</a></li>
						<li><a href="#panel-management" data-toggle="tab">管理</a></li>
						<li><a href="#panel-message" data-toggle="tab">消息</a></li>
						<li><a href="#panel-setting" data-toggle="tab">设置</a></li>
						<li><a href="#panel-exit" data-toggle="tab">退出</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane active" id="panel-fiveservice">
							<h3>
								<a href="home/service.jsp">发起服务</a>
							</h3>
						...
						<div class="tab-pane" id="panel-setting">
							<h3>
								<a href="home/userinfo.jsp">管理用户信息</a>
							</h3>
							<h3>
								<a href="home/personal.jsp">登陆</a>
							</h3>
							<h3>
