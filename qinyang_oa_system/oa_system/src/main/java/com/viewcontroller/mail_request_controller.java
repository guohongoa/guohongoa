...
public class mail_request_controller
{
		   ...
		   )
   {
	   ...
	   _mail_info.set_mail_sender_id(mail_sender_id);
	   _mail_info.set_mail_receiver(mail_receiver);
	   _mail_info.set_mail_receiver_id(mail_receiver_id);
